...
def stage3():
    while True:
        ...
        button("Level 1",(display_width/2)+10,200,100,50,GOLD,GRAY,level8)
        button("Level 2",(display_width/2)-110,260,100,50,GOLD,GRAY,level9)
        button("Level 3",(display_width/2)+10,260,100,50,GOLD,GRAY,level10)
...
def level8():
	...
	while not done:
		...
		#screen.fill(BLACK)
                ...
                button("Menu",0,5,50,20,GRAY,WHITE,stage3)
